...
> **ARCHIVED (2026-08-01):** This file documents the retired FreeCAD
> pipeline (spec → FreeCAD script → STEP/OBJ/IFC → Blender import). The
> current pipeline is pure Python (`src/homedesign/`) + headless Blender.
> The Blender-era lessons live in `docs/lessons-learned.md`.
